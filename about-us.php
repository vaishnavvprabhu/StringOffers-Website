...
<main id="main">
    ...
    <!-- ======= Hero Section ======= -->
    <section id="about" class="d-flex align-items-center vh-100">

        <div class="container">
            <div class="row">
                <div class="col-lg-4 order-1 order-lg-2 " data-aos="zoom-in" data-aos-delay="200">
                    <div class="">
                        <div class="row ">
                            <h1>About Us</h1>
...
We offer the best-performing advertising offers on the internet, with real-time tracking, highest payouts, scheduled payments, and 24/7 professional support. Our ultimate goal is to empower our users to succeed in their affiliate marketing efforts and grow their businesses. Join us today and take your affiliate marketing to the next level!
                ...
                <div class="col-lg-8 order-1 order-lg-2" data-aos="zoom-in" data-aos-delay="200">
                    <div class="">
                        <div class="row">
                            <div class="col-lg-12 text-center order-1 order-lg-2" data-aos="zoom-in"
                                data-aos-delay="200">
                                <img src="assets/img/aboutus.png" class="img-fluid animated" alt="">
                            </div>
