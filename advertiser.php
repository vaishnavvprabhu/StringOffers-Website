...
<section id="Advertiser" class="d-flex align-items-center">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 order-1 order-lg-2 side-gap-2" data-aos="zoom-in" data-aos-delay="200">
                <div class="">
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-4">
                                            <div class="box-color">
                                                <p>Daily improvisation and creative ads are the plus points. Live
                                                    Customer Support is the main what attracts Advertisers to be part of
                                                    Adsterra.”</p>
                                                <div>
                                ...
                                <div class="carousel-inner">
                                    ...
                                    <div class="item  active box-t" style="background-color:#e3e3e3;">
                                        <div class="col-xs-12 col-sm-6 col-md-3">
                                            <div class="">
                                                <img src="assets/img/clientlogo1.png" class="img-responsive">
                                            </div>
                                        </div>
                                    </div>
